...
#define sigPin 4 //set PPM signal output pin on the arduino GPIO Number!!!
...
// MULTIWII
//  ppm[0] = doc["throttle"]; // 1500
//  ppm[3] = doc["pitch"]; // 1414
//  ppm[2] = doc["roll"]; // 1599
//  ppm[1] = doc["yaw"]; // 1500
//  ppm[4] = doc["aux1"]; // 1500
//  ppm[5] = doc["aux2"]; // 1400
...
//  ppm[7] = 1000; // 1400
  ...
  ppm[0] = int(doc["throttle"]); // 1500
  ppm[1] = int(doc["yaw"]); // 1500
  ppm[2] = int(doc["pitch"]); // 1599
  ppm[3] = int(doc["roll"]); // 1414
  ppm[4] = int(doc["aux1"]); // 1500
  ppm[5] = int(doc["aux2"]); // 1400
